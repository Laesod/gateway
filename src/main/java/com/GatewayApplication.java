			...
			http
				...
				.and()
					.authorizeRequests()
						...
						.antMatchers("/#/login", "/gateway/login", "/gateway/getUserProfile", "/login?logout", "/", "/index.html", "/favicon.ico", "favicon.ico", "/build/**", "/views/**", "/img/**",  "/templates/**", "/fonts/**", "/gateway/createUser", "/gateway/activateUser", "/gateway/initiateResetPassword",  "/gateway/resetPassword", "/gateway/config").permitAll()
